  ...
  return (
    <div className="netflix-header">
      ...
      <div className="secondary-navigation">
        ...
        <div className="nav-element">
          <Link to="/childrenhome" className="nav-link">Children</Link>
        </div>
        
        {/* Notification Dropdown */}
        <div
          className="nav-element notification-menu-item"
                ...
                <ul className="sub-menu-list notifications" role="list" aria-label="Notifications">
                  <li className="sub-menu-item notification">
                    <div className="notification-item">
                      <span>New movie added: Extraction 2</span>
                    </div>
                  </li>
                  <li className="sub-menu-item notification">
                    <div className="notification-item">
                      <span>Trending: The Witcher Season 3</span>
                    </div>
                  </li>
                  <li className="sub-menu-item notification">
                    <div className="notification-item">
                      <span>Recommended: Heart of Stone</span>
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div className="account-dropdown-button">
            <div className="avatar-wrapper">
              <img
                ...
                src="https://occ-0-2087-2186.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABX4L9w79aT7nijZVgdNGkMraiqSPBtchAJv6ufbTi63POCqjyeH33eWZhDE7GITmH28pVz8rDrrSiJTYJIukt6h34Nyoqnw.png?r=eda"
                alt=""
              />
              <div className="callout-arrow"></div>
            </div>
            <div className={`caret ${showProfileMenu ? 'open' : ''}`}></div>
          </div>
          {showProfileMenu && (
            <div
            ...
            >
              <div className="ptrack-content">
                    ...
                    <div>
                      <a className="profile-link" href="/profile">
                        <div className="avatar-wrapper">
                          <img 
                            className="profile-icon" 
                            src="https://occ-0-7338-2186.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABX4L9w79aT7nijZVgdNGkMraiqSPBtchAJv6ufbTi63POCqjyeH33eWZhDE7GITmH28pVz8rDrrSiJTYJIukt6h34Nyoqnw.png?r=eda" 
                            alt="" 
                          />
                        </div>
                        Bhushan {/* Profile name directly inside the <a> tag */}
                      </a>
                    </div>
                  </li>
                  <li className="sub-menu-item profile">
                    <div>
                      <a className="profile-link" href="/profile">
                        <div className="avatar-wrapper">
                          <img 
                            className="profile-icon" 
                            src="https://occ-0-7338-2186.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABXz4LMjJFidX8MxhZ6qro8PBTjmHbxlaLAbk45W1DXbKsAIOwyHQPiMAuUnF1G24CLi7InJHK4Ge4jkXul1xIW49Dr5S7fc.png?r=e6e" 
                            alt="Profile 1" 
                          />
                        </div>
                        Nikita {/* Profile name directly inside the <a> tag */}
                      </a>
                    </div>
                  </li>
                  <li className="sub-menu-item profile">
                    <div>
                      <a className="profile-link" href="/profile">
                        <div className="avatar-wrapper">
                          <img 
                            className="profile-icon" 
                            src="https://occ-0-7338-2186.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABeuqjuQsRgqEDlibtJTI5BMf8IxhLlLOeIT6xI4TL57mqv7XHja43gx02S8pZVe8JNGRQXjnrUk1VcsTXqi83tFKPI6OR3k.png?r=bd7" 
                            alt="Profile 2" 
                          />
                        </div>
                        Bhakti {/* Profile name directly inside the <a> tag */}
                      </a>
                    </div>
                  </li>
                </ul>
                ...
                <ul className="account-links sub-menu-list" aria-label="Account">
                  ...
                  <li className="sub-menu-item">
                    <a className="sub-menu-link sub-menu-link-icon" href="https://help.netflix.com/">
                      <svg className="svg-icon" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12ZM12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0ZM12 8C10.6831 8 10 8.74303 10 9.5H8C8 7.25697 10.0032 6 12 6C13.9968 6 16 7.25697 16 9.5C16 10.8487 14.9191 11.7679 13.8217 12.18C13.5572 12.2793 13.3322 12.4295 13.1858 12.5913C13.0452 12.7467 13 12.883 13 13V14H11V13C11 11.5649 12.1677 10.6647 13.1186 10.3076C13.8476 10.0339 14 9.64823 14 9.5C14 8.74303 13.3169 8 12 8ZM13.5 16.5C13.5 17.3284 12.8284 18 12 18C11.1716 18 10.5 17.3284 10.5 16.5C10.5 15.6716 11.1716 15 12 15C12.8284 15 13.5 15.6716 13.5 16.5Z"/>
                      </svg>
                      <span>Help Centre</span>
                    </a>
                  </li>
                  <li className="sub-menu-item">
                    <a className="sub-menu-link sub-menu-link-icon" href="/settings">
                      <svg className="svg-icon" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M19.739 12.042c.006-.057.011-.114.011-.171 0-.057-.005-.114-.011-.171l1.786-1.457c.133-.109.171-.271.095-.422l-1.667-2.886c-.076-.151-.244-.229-.395-.153l-1.984.805c-.305-.218-.628-.412-.964-.581l-.286-2.096c-.026-.15-.144-.261-.294-.261h-3.5c-.15 0-.262.111-.294.261l-.286 2.096c-.336.169-.659.363-.964.581l-1.984-.805c-.151-.076-.318.002-.395.153l-1.667 2.886c-.076.151-.038.313.095.422l1.786 1.457c.006.057.011.114.011.171 0 .057-.005.114-.011.171l-1.786 1.457c-.133.109-.171.271-.095.422l1.667 2.886c.076.151.244.229.395.153l1.984-.805c.305.218.628.412.964.581l.286 2.096c.026.15.144.261.294.261h3.5c.15 0 .262-.111.294-.261l.286-2.096c.336-.169.659-.363.964-.581l1.984.805c.151.076.318-.002.395-.153l1.667-2.886c.076-.151.038-.313-.095-.422l-1.786-1.457zm-7.739 2.458c-2.894 0-5.25-2.356-5.25-5.25 0-2.894 2.356-5.25 5.25-5.25 2.894 0 5.25 2.356 5.25 5.25 0 2.894-2.356 5.25-5.25 5.25zM12 9.292c-1.491 0-2.708 1.217-2.708 2.708 0 1.491 1.217 2.708 2.708 2.708 1.491 0 2.708-1.217 2.708-2.708 0-1.491-1.217-2.708-2.708-2.708z"/>
                      </svg>
                      <span>Settings</span>
                    </a>
                  </li>
                ...
                <ul className="sub-menu-list sign-out-links">
                  <li className="sub-menu-item">
                    <a className="sub-menu-link" href="#" onClick={handleSignOut}>
                      Sign out of Netflix
                    </a>
                  </li>
                </ul>
