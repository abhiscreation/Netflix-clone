        ...
        <div className="nav-element">
          <div className="account-dropdown">
            <div className="profile-icon">
              <img src="https://occ-0-2087-2186.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABX4L9w79aT7nijZVgdNGkMraiqSPBtchAJv6ufbTi63POCqjyeH33eWZhDE7GITmH28pVz8rDrrSiJTYJIukt6h34Nyoqnw.png?r=eda" alt="Profile" />
            </div>
