...
const Footer = () => (
  <div role="contentinfo" className="member-footer" id="member-footer" data-uia="member-footer">
    <div className="social-links">
      <a className="social-link" href="https://www.facebook.com/NetflixIN/" target="_blank" aria-label="facebook" rel="noopener noreferrer">
        {/* Facebook SVG */}
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="24" height="24" data-icon="FacebookStandard" aria-hidden="true" className="svg-icon svg-icon-facebook-logo">
      ...
      <a className="social-link" href="https://www.instagram.com/Netflix_IN/" target="_blank" aria-label="instagram" rel="noopener noreferrer">
        {/* Instagram SVG */}
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="24" height="24" data-icon="InstagramStandard" aria-hidden="true" className="svg-icon svg-icon-instagram-logo">
      ...
      <a className="social-link" href="https://twitter.com/netflixindia" target="_blank" aria-label="twitter" rel="noopener noreferrer">
        {/* Twitter SVG */}
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="24" height="24" data-icon="TwitterStandard" aria-hidden="true" className="svg-icon svg-icon-twitter-logo">
      ...
      <a className="social-link" href="https://www.youtube.com/channel/UCZSNzBgFub_WWil6TOTYwAg" target="_blank" aria-label="youtube" rel="noopener noreferrer">
        {/* Youtube SVG */}
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 24 24" width="24" height="24" data-icon="YoutubeStandard" aria-hidden="true" className="svg-icon svg-icon-youtube-logo">
    ...
    <div className="footer-columns">
      <div className="footer-column">
        <a className="member-footer-link" href="/browse/audio-description" target="_self">Audio Description</a>
        <a className="member-footer-link" href="https://help.netflix.com/" target="_self">Help Centre</a>
        <a className="member-footer-link" href="/redeem" target="_self">Gift Cards</a>
      </div>
      <div className="footer-column">
        <a className="member-footer-link" href="https://media.netflix.com/" target="_self">Media Centre</a>
        <a className="member-footer-link" href="http://ir.netflix.com/" target="_self">Investor Relations</a>
        <a className="member-footer-link" href="https://jobs.netflix.com/" target="_self">Jobs</a>
      </div>
      <div className="footer-column">
        <a className="member-footer-link" href="https://help.netflix.com/legal/termsofuse" target="_self">Terms of Use</a>
        <a className="member-footer-link" href="https://help.netflix.com/legal/privacy" target="_self">Privacy</a>
        <a className="member-footer-link" href="https://help.netflix.com/legal/notices" target="_self">Legal Notices</a>
      </div>
      <div className="footer-column">
        <a className="member-footer-link" href="/Cookies" target="_self">Cookie Preferences</a>
        <a className="member-footer-link" href="https://help.netflix.com/legal/corpinfo" target="_self">Corporate Information</a>
        <a className="member-footer-link" href="https://help.netflix.com/contactus" target="_self">Contact Us</a>
      </div>
    </div>
    <div className="member-footer-service">
      <button className="service-code" data-uia="service-code-button">Service Code</button>
    </div>
    <div className="member-footer-copyright" data-uia="member-footer-copyright">
